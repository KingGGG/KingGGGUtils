...
import com.KinFourGUtils.bean.Point;
import com.KinFourGUtils.utils.MathUtil;
...
public class LocusPassWordView extends View {
    ...
    private int errorColor = 0xffea0945; // 错误线的颜色
    private int selectedColor = 0xffa8582d; // 线的颜色

    private int outterSelectedColor = 0xffa8582d;// 外圈选中时颜色
    private int outterErrorColor = 0xff901032; // 外圈错误时颜色

    private int dotColor = 0xff9AB4F9;//外圈的颜色 未选中
    private int outterDotColor = 0xff9AB4F9;//内圈的颜色 未选中

    public void setShortPWDHint(String shortPWDHint) {
        this.shortPWDHint = shortPWDHint;
    }

    private String shortPWDHint;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (isFinish) {
            if (this.sPoints.size() == 1) {
                ...
                error();
                clearPassword();
                ToastUtils.showLong(shortPWDHint, getContext());
